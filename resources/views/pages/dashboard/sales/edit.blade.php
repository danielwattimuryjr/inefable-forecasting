          ...
          <form action="{{ route('sales.update', $sale) }}" method="post">
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <select name="product_id" class="form-control @error('product_id') is-invalid @enderror" readonly>
              ...
              <div class="form-group">
                ...
                <input type="date" id="periode_penjualan" name="periode_penjualan"
                  ...
                  value="{{ old('periode_penjualan') ?? $sale->periode_penjualan  }}">
              ...
              <div class="form-group">
                ...
                <input type="number" name="jumlah_penjualan"
                  ...
                  value="{{ old('jumlah_penjualan') ?? $sale->jumlah_penjualan }}" min="0">
